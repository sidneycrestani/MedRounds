import { pgTable, uuid, text, jsonb, integer, uniqueIndex } from 'drizzle-orm/pg-core'
...
export const casesTags = pgTable('cases_tags', {
  caseId: uuid('case_id').references(() => clinicalCases.id, { onDelete: 'cascade' }).notNull(),
